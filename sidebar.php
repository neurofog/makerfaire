	...
	<div class="home-sidebar">
		...
		<div class="newsletter">
			<div class="robot pull-left"><img src="http://makerfaire.com/new/images/robot.png"/></div>
			...
			<div class="row" style="">
				...
				<div class="hide" style="margin-left:20px;">
					...
					<h3><label class="control-label" for="inlineCheckboxes">Preferred Faire?</label></h3>
						<div class="controls" style="margin-top: -10px;margin-left: 5px;">
					<h3><label class="checkbox inline" for="cm188882" style="padding-top: 8px;padding-right: 10px;">
					...
					<div class="control-group">
						<div class="controls">
							<h3 style="margin-left:5px"><label class="checkbox inline" for="cm188888">
			...
			<div>
				<input type="text" placeholder="Enter your email" class="span2 small" name="cm-jjuruj-jjuruj" id="jjuruj-jjuruj"> <input type="submit" value="Go!" style="margin-bottom:9px;" class="btn btn-danger btn-small">
			</div>
			</form>
			</div>
		</div> 
		...
		<div class="count">
			...
			<csinclude record="lc/maker_faire_2012_sponsor_slider" field="html" />

			<?php get_template_part('sponsor-slider'); ?>


			<div id="house_ad" style="margin-top:25px;" onclick="location.href='https://readerservices.makezine.com/MK/subscribe.aspx'"></div>						
