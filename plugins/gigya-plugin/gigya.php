...
Description: Increase Registration and Engagement by integrating the Gigya service into your WordPress self hosted blog.
...
define("GIGYA_PLUGIN_URL", get_template_directory_uri() . '/plugins/gigya');
define("GIGYA_PLUGIN_PATH", get_template_directory() . '/plugins/gigya');
define("GIGYA_IS_3_2", (floatval(get_bloginfo("version")) >= 3.2));

require_once(dirname(__FILE__) . '/resources/staticdata.php'); // Contains all the static data for our admin page
require_once(dirname(__FILE__) . '/resources/core.php'); // Core functions such as linking styles/JS and others
require_once(dirname(__FILE__) . '/resources/user.php'); // The class that holds the user methods
